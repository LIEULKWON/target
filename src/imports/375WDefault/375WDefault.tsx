import svgPaths from "./svg-8s6bv6av3y";
  ...
  return (
    <div className="absolute inset-[15.27%_10.26%] opacity-20" data-name="Group">
      <div className="absolute inset-[-21.98%_-12.9%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1500 1007.69">
          <g filter="url(#filter0_f_7_3182)" id="Group">
            <path clipRule="evenodd" d={svgPaths.p2146a500} fill="var(--fill-0, #FB923C)" fillRule="evenodd" id="Vector" style={{ fill: "color(display-p3 0.9843 0.5725 0.2353)", fillOpacity: "1" }} />
            <path clipRule="evenodd" d={svgPaths.p7eaed80} fill="var(--fill-0, #F9A8D4)" fillRule="evenodd" id="Vector_2" style={{ fill: "color(display-p3 0.9765 0.6588 0.8314)", fillOpacity: "1" }} />
            <path clipRule="evenodd" d={svgPaths.p1ffda00} fill="var(--fill-0, #818CF8)" fillRule="evenodd" id="Vector_3" style={{ fill: "color(display-p3 0.5059 0.5490 0.9725)", fillOpacity: "1" }} />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1007.69" id="filter0_f_7_3182" width="1500" x="1.27383e-08" y="-1.21631e-06">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_7_3182" stdDeviation="76.9231" />
            </filter>
          </defs>
        </svg>
      </div>
...
function BackgroundSvg() {
  return (
    <div className="h-[1007.692px] overflow-clip relative shrink-0 w-[1500px]" data-name="background.svg">
      <Group />
    </div>
  );
}
...
function BackgroundSvgFill() {
  return (
    <div className="absolute content-stretch flex flex-col h-[2135px] items-center justify-center left-0 overflow-clip py-[563.654px] top-0 w-[375px]" data-name="background.svg fill">
      <BackgroundSvg />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M2.66667 8H13.3333" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
          <path d="M2.66667 4H13.3333" id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
          <path d="M2.66667 12H13.3333" id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
        </g>
      </svg>
    </div>
  );
...
function Svg1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p32887f80} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
          <path d={svgPaths.p3694d280} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
          <path d={svgPaths.p1f197700} id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
          <path d={svgPaths.p3bf3e100} id="Vector_4" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
        </g>
      </svg>
    </div>
  );
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-center max-w-[140px] overflow-clip relative shrink-0" data-name="Container">
    ...
    <div className="relative shrink-0 size-[14px]" data-name="SVG">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG" opacity="0.6">
          <path d="M3.5 5.25L7 8.75L10.5 5.25" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" style={{ stroke: "color(display-p3 0.0394 0.0394 0.0394)", strokeOpacity: "1" }} />
        </g>
      </svg>
    </div>
  );
...
function ButtonMenu() {
  return (
    <div className="content-stretch flex gap-[6px] items-center px-[8px] py-[4px] relative rounded-[8px] shrink-0" data-name="Button menu">
      <Svg1 />
      <Container2 />
      <Svg2 />
    </div>
...
function Container1() {
  return (
    <div className="content-stretch flex items-center pr-[16px] relative shrink-0" data-name="Container">
      <ButtonMenu />
    </div>
  );
}
...
function Margin() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-[146.47999572753906px] relative" data-name="Margin">
      <div className="flex flex-col items-end min-w-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end min-w-[inherit] pl-[167.516px] relative w-full">
          <Container1 />
        </div>
      </div>
    </div>
...
function HorizontalBorder() {
  return (
    <div className="absolute content-stretch flex gap-[17.004px] h-[61px] items-center left-0 pb-px pl-[16px] right-0 top-0" data-name="HorizontalBorder">
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Geist:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[30px] w-full">
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6c737f] text-[14px] w-full">
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center min-w-[80px] relative self-stretch shrink-0 w-[87.66px]" data-name="Container">
      <Container12 />
      <Container14 />
    </div>
  );
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center min-w-[80px] relative self-stretch shrink-0 w-[87.67px]" data-name="Container">
      <Container16 />
      <Container18 />
    </div>
  );
...
function Background() {
  return (
    <div className="bg-[#f5f5f5] relative rounded-[14px] shrink-0 w-full" data-name="Background">
      <div className="content-stretch flex flex-col items-start px-[16px] py-[20px] md:px-[24px] md:py-[32px] relative w-full">
        <Container10 />
      </div>
    </div>
  );
...
function Button3() {
  return (
    <div className="absolute bg-[rgba(243,243,243,0.2)] content-stretch flex flex-col h-[36px] items-center justify-center left-0 px-[17px] py-px right-[217.34px] rounded-bl-[10px] rounded-tl-[10px] top-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] text-center whitespace-nowrap">
...
function Button4() {
  return (
    <div className="absolute bg-[rgba(243,243,243,0.2)] content-stretch flex flex-col h-[36px] items-center justify-center left-[-1px] px-[17px] py-px right-0 rounded-br-[10px] rounded-tr-[10px] top-0" data-name="Button">
...
function ButtonMargin() {
  return (
    <div className="absolute h-[36px] left-[218.34px] right-0 top-0" data-name="Button:margin">
      <Button4 />
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute bg-[#171717] content-stretch flex flex-col h-[36px] items-center justify-center left-[-1px] px-[17px] py-px right-0 top-0" data-name="Button">
...
function ButtonMargin1() {
  return (
    <div className="absolute h-[36px] left-[109.66px] right-[108.67px] top-0" data-name="Button:margin">
      <Button5 />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[58px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Label1 />
      <Container30 />
    </div>
  );
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pr-[49.24px] relative shrink-0" data-name="Container">
  ...
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[13px] pr-[49px] py-[7.75px] relative size-full">
          <Container35 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
...
function Container43() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pr-[49.33px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[16px] whitespace-nowrap">
...
function Background2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#f5f5f5] content-stretch flex h-[20px] items-center justify-center min-w-[20px] px-[4px] right-[11.14px] rounded-[6px] top-1/2" data-name="Background">
      <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#6c737f] text-[12px] text-center whitespace-nowrap">
...
function Container31() {
  return (
    <div className="content-stretch flex flex-col gap-[4.5px] h-[60px] items-start pt-[5.5px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pr-[229.71px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[16px] whitespace-nowrap">
...
function Background3() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#f5f5f5] content-stretch flex h-[20px] items-center justify-center min-w-[20px] px-[4px] right-[11.7px] rounded-[6px] top-1/2" data-name="Background">
      <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#6c737f] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">Min</p>
      </div>
    </div>
...
function Container56() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pr-[38.08px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[16px] whitespace-nowrap">
...
function Container62() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pr-[27.32px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[16px] whitespace-nowrap">
...
function Slider() {
  return (
    <div className="absolute bg-[#f3f3f3] left-[217.7px] rounded-[16777200px] size-[16px] top-[-5px]" data-name="Slider">
...
function Container67() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8.01px] items-center justify-end relative w-full">
        <Button6 />
        <Button7 />
      </div>
    </div>
...
function BackgroundShadow() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start overflow-clip py-[24px] relative rounded-[14px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Background+Shadow">
      <Container8 />
      <Container9 />
    </div>
  );
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col h-[761px] items-start relative shrink-0 w-full" data-name="Container">
      <BackgroundShadow />
    </div>
  );
}
...
function Form1({ onExtractClick }: { onExtractClick?: () => void }) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px relative w-full" data-name="Form">
      ...
      <Container75 />
      <Container84 />
      <Container95 onExtractClick={onExtractClick} />
    </div>
  );
}
...
function Container72({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
...
function Background7({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] h-[605px] items-start py-[24px] relative rounded-[14px] shrink-0 w-full" data-name="Background">
      ...
      <Container68 />
      <Container72 onExtractClick={onExtractClick} isExtracting={isExtracting} onCancelExtraction={onCancelExtraction} />
    </div>
  );
}

function Container6({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container7 />
      <Background7 onExtractClick={onExtractClick} isExtracting={isExtracting} onCancelExtraction={onCancelExtraction} />
    </div>
  );
}
...
function Background11() {
  return (
    <div className="bg-black content-stretch flex h-[24px] items-center justify-center min-w-[24px] px-[8.15px] py-[4px] relative rounded-[16777200px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Space_Grotesk:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
...
function Container103() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] text-center whitespace-nowrap">
...
function Combobox() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-full" data-name="Combobox">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="flex flex-row items-center justify-center size-full">
...
function Cell() {
  return (
    <div className="relative shrink-0 w-[38.19px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[18.5px] pt-[18px] px-[12px] relative w-full">
...
function Cell1() {
  return (
    <div className="relative shrink-0 w-[87.39px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[12px] py-[8px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
          <p className="leading-[20px] mb-0">Assigned</p>
...
function Cell2() {
  return (
    <div className="relative shrink-0 w-[72.26px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[12px] py-[8px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
          <p className="leading-[20px] mb-0">Profile</p>
          <p className="leading-[20px]">Handle</p>
        </div>
      </div>
    </div>
  );
...
function Cell3() {
  return (
    <div className="relative shrink-0 w-[78.56px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[12px] py-[8px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
          <p className="leading-[20px] mb-0">Created</p>
          <p className="leading-[20px]">At</p>
        </div>
      </div>
    </div>
  );
...
function Cell4() {
  return (
    <div className="relative shrink-0 w-[85.25px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[12px] py-[8px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
          <p className="leading-[20px] mb-0">Actioned</p>
          <p className="leading-[20px]">At</p>
        </div>
      </div>
    </div>
...
function Cell5() {
  return (
    <div className="relative shrink-0 w-[85.83px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[18.5px] pt-[18px] px-[12px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
...
function Cell6() {
  return (
    <div className="relative shrink-0 w-[69.03px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[18.5px] pt-[18px] px-[12px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
...
function Cell7() {
  return (
    <div className="relative shrink-0 w-[83.2px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[18.5px] pt-[18px] px-[12px] relative w-full">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[0.35px] whitespace-nowrap">
...
function Header() {
  return (
    <div className="bg-[rgba(243,243,243,0.5)] h-[56.5px] relative shrink-0 w-full" data-name="Header">
      <Row />
    </div>
  );
}
...
function BodyRowData() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-[551.7px]" data-name="Body → Row → Data">
      <Background12 />
      <Container105 />
      <Margin4 />
    </div>
...
function Table() {
  return (
    <div className="content-stretch flex flex-col gap-[64.5px] items-center pb-[64px] relative shrink-0 w-[599.7px]" data-name="Table">
      <Header />
      <BodyRowData />
    </div>
  );
...
function Container104() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-auto pb-[15px] relative shrink-0 w-full" data-name="Container">
      <Table />
    </div>
  );
}
...
function LinkGoToPreviousPage() {
  return (
    <div className="content-stretch flex items-center justify-center opacity-50 px-[13px] py-[10px] relative rounded-[8px] shrink-0" data-name="Link - Go to previous page">
...
function LinkGoToNextPage() {
  return (
    <div className="content-stretch flex items-center justify-center opacity-50 px-[13px] py-[10px] relative rounded-[8px] shrink-0" data-name="Link - Go to next page">
      <div aria-hidden="true" className="absolute border border-[#e4e4e7] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Svg18 />
    </div>
  );
...
function NavigationPagination() {
  return (
    <div className="content-stretch flex h-[36px] items-start justify-center relative shrink-0 w-full" data-name="Navigation - pagination">
      <List />
    </div>
  );
}
...
function Container110() {
  return (
    <div className="content-stretch flex flex-col items-start justify-between pt-[8px] relative shrink-0 w-full" data-name="Container">
      <Container111 />
...
function Background10() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start py-[24px] relative rounded-[14px] shrink-0 w-full" data-name="Background">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[14px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Overlay+Shadow" />
      <Container100 />
      <Container101 />
    </div>
...
function Container3({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-0 pt-[16px] right-0 top-[61px]" data-name="Container">
      <Container4 />
      <Container6 onExtractClick={onExtractClick} isExtracting={isExtracting} onCancelExtraction={onCancelExtraction} />
      <Background10 />
    </div>
  );
}
...
function Main({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="Main">
      <BackgroundSvgFill />
      <HorizontalBorder />
      <Container3 onExtractClick={onExtractClick} isExtracting={isExtracting} onCancelExtraction={onCancelExtraction} />
    </div>
  );
}

function Container({ onExtractClick, isExtracting, onCancelExtraction }: { onExtractClick?: () => void; isExtracting?: boolean; onCancelExtraction?: () => void }) {
  return (
    <div className="content-stretch flex h-[2135px] items-start justify-center min-h-[750px] relative shrink-0 w-full" data-name="Container">
      <Main onExtractClick={onExtractClick} isExtracting={isExtracting} onCancelExtraction={onCancelExtraction} />
    </div>
  );
}

export default function Component375WDefault({ onExtractionStateChange }: { onExtractionStateChange?: (isExtracting: boolean) => void } = {}) {
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="375w default" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 243, 243) 0%, rgb(243, 243, 243) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Container onExtractClick={handleExtractClick} isExtracting={isExtracting} onCancelExtraction={handleCancelExtraction} />
    </div>
  );
}